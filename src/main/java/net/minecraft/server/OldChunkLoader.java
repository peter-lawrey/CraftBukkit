...
public class OldChunkLoader {
    public static OldChunk a(NBTTagCompound paramNBTTagCompound) {
        ...
        localOldChunk.h = paramNBTTagCompound.getList("Entities", 10);
        localOldChunk.i = paramNBTTagCompound.getList("TileEntities", 10);
        localOldChunk.j = paramNBTTagCompound.getList("TileTicks", 10);
        try {
